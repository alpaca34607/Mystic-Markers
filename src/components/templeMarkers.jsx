...
const templeMarkers = [
    ...
    generateMarkerData("taipei-longshan-temple", {
        ...
        city: "台北市",
        district: "萬華區",
        coverPhoto: "images/Map/taipei-longshan-temple.jpg",
...
generateMarkerData("tainan-confucius-temple", {
    ...
    city: "台南市",
    district: "中西區",
    coverPhoto: "images//Map/tainan-confucius-temple.jpg",
...
generateMarkerData("taichung-baojue-temple", {
    ...
    city: "台中市",
    district: "北區",
    coverPhoto: "images/Map/default-temple.jpg",
...
generateMarkerData("kaohsiung-zuoying-temple", {
    ...
    city: "高雄市",
    district: "左營區",
    coverPhoto: "images/Map/kaohsiung-zuoying-temple.jpg",
...
generateMarkerData("taipei-matsu-temple", {
    ...
    city: "台北市",
    district: "松山區",
    coverPhoto: "images/Map/taipei-matsu-temple.jpg",
  ...
  generateMarkerData("tainan-grand-matsu-temple", {
    ...
    city: "台南市",
    district: "中西區",
    coverPhoto: "images/Map/tainan-grand-matsu-temple.jpg",
  ...
  generateMarkerData("new-taipei-qingshui-temple", {
    ...
    city: "新北市",
    district: "三峽區",
    coverPhoto: "images/Map/new-taipei-qingshui-temple.jpg",
  ...
  generateMarkerData("kaohsiung-guandi-temple", {
    ...
    city: "高雄市",
    district: "左營區",
    coverPhoto: "images/Map/kaohsiung-guandi-temple.jpg",
  ...
  generateMarkerData("taichung-guandi-temple", {
    ...
    city: "台中市",
    district: "中區",
    coverPhoto: "images/Map/taichung-guandi-temple.jpg",
  ...
  generateMarkerData("keelung-matsu-temple", {
    ...
    city: "基隆市",
    district: "仁愛區",
    coverPhoto: "images/Map/keelung-matsu-temple.jpg",
  ...
  generateMarkerData("chiayi-land-god-temple", {
    ...
    city: "嘉義市",
    district: "東區",
    coverPhoto: "images/Map/chiayi-land-god-temple.jpg",
  ...
  generateMarkerData("nantou-matsu-temple", {
    ...
    city: "南投縣",
    district: "南投市",
    coverPhoto: "images/Map/nantou-matsu-temple.jpg",
...
generateMarkerData("changhua-lukang-matsu-temple", {
    ...
    city: "彰化縣",
    district: "鹿港鎮",
    coverPhoto: "images/Map/changhua-lukang-matsu-temple.jpg",
  ...
  generateMarkerData("yunlin-beigang-matsu-temple", {
    ...
    city: "雲林縣",
    district: "北港鎮",
    coverPhoto: "images/Map/yunlin-beigang-matsu-temple.jpg",
  ...
  generateMarkerData("hualien-guandi-temple", {
    ...
    city: "花蓮縣",
    district: "花蓮市",
    coverPhoto: "images/Map/hualien-guandi-temple.jpg",
  ...
  generateMarkerData("kaohsiung-matsu-temple", {
    ...
    city: "高雄市",
    district: "旗津區",
    coverPhoto: "images/Map/kaohsiung-matsu-temple.jpg",
